...
let alivePresidents = presidentsArray.filter((president) => president.passed === undefined);
console.log(alivePresidents);


// ? Create a list of all the presidents that have passed

let passedPresidents = presidentsArray.filter((president) => president.passed !== undefined);
console.log(passedPresidents);


// ? Create a loop that goes through the passed presidents and figure out the age at which they dies

for(president of passedPresidents ) {
    let age = president.passed - president.year;
    console.log(`President ${president.first} ${president.last} was ${age} years old when he passed away in the year of ${president.passed}.`)
}


// ?  See if you can find the president that has the highest and lowest age.
